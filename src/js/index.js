...
let zeroCanvas = 
document.getElementsByClassName("zero--canvas")[0];
zeroCanvas.setAttribute("style","display:none");
...
let fifthCanvas = 
document.getElementsByClassName("fifth--canvas")[0];
...
let removethirdCanvas = setTimeout(function(){
	thirdCanvas.setAttribute("style","display:none");
	zeroCanvas.setAttribute("style","display:block")
},18000);
